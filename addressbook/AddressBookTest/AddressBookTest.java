...
public class AddressBookTest {
  ...
  public void testRemoveNormalOneButNotThere() {
    ...
    AddressEntry addressEntry2 = new AddressEntry.Builder("Peihong")
    .address("NYU").email("pc1336@nyu.edu").phone("917-688-9725")
    .note("Peihong's taking PQS").build(); 
  ...
  public void testSaveAndRead() {
    ...
    List<AddressEntry> tempEntries = addressBook.search("Peihong");
    List<AddressEntry> tempEntries2 = tempAddressBook.search("Peihong");
